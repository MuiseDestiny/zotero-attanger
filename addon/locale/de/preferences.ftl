...
auto-rename-on-modify-debounce = Entprellzeit für Umbenennung nach Bearbeitung (ms)
auto-rename-on-modify-delay = Verzögerung für Umbenennung nach Bearbeitung (ms)
auto-move =

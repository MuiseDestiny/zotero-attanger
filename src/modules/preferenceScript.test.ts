...
describe("preferenceScript", () => {
  ...
  describe("bindPrefEvents - choose source dir", () => {
    ...
    it("should not set pref when file picker is cancelled", async () => {
      mockGetPref.mockImplementation((key: string) => {
        if (key === "sourceDir") return "/old/path";
        return undefined;
      });
    ...
    it("should not set pref when file picker returns empty path", async () => {
      mockGetPref.mockImplementation((key: string) => {
        if (key === "sourceDir") return "/old/path";
        return undefined;
      });
  ...
  describe("bindPrefEvents - choose dest dir", () => {
    ...
    it("should not set pref when file picker is cancelled", async () => {
      mockGetPref.mockImplementation((key: string) => {
        if (key === "destDir") return "/old/path";
        return undefined;
      });
